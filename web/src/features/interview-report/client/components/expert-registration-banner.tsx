  ...
  return (
    <div className="bg-mirai-light-gradient rounded-2xl border border-primary p-6 flex flex-col gap-6">
      <div className="flex flex-col gap-4">
        <span className="inline-flex items-center justify-center rounded-2xl bg-primary text-primary-foreground px-4 py-2 text-sm font-medium w-fit">
          議案に詳しい方・当事者の方へ
        </span>
        <div className="flex flex-col gap-2.5">
          ...
          <p className="text-[15px] text-mirai-text">
            現場の知見を議案の論点整理に活かすため、登録をいただいた方には、今後追加のインタビューをお願いする場合があります。
          </p>
        </div>
      </div>
